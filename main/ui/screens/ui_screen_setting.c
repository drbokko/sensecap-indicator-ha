...
lv_obj_set_height( ui_panel_top_4, 30);
lv_obj_set_x( ui_panel_top_4, 0 );
lv_obj_set_y( ui_panel_top_4, 10 );
...
lv_obj_set_width( ui_wifi__st_button_ha_setting, 30);
lv_obj_set_height( ui_wifi__st_button_ha_setting, 30);
...
lv_obj_set_height( ui_Container_Setting, 30);
lv_obj_set_x( ui_Container_Setting, 15 );
lv_obj_set_y( ui_Container_Setting, 15 );
...
lv_obj_set_x( ui_setting_title1, 0 );
lv_obj_set_y( ui_setting_title1, -3 );
...
lv_obj_set_x( ui_setting_icon1, 0 );
lv_obj_set_y( ui_setting_icon1, -5 );
